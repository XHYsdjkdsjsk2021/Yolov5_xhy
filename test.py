...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/best_for_m.pt', help='model.pt path')
    parser.add_argument('--data', type=str, default='../Garbage/data.yaml', help='*.data path')
